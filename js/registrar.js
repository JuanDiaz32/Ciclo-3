...
listaProductos.push("Mouse");    //agregar elemento
listaProductos.pop();            //eliminar el último elemento de la lista

listaProductos[5] = "Pantalla";

let cadena = listaProductos.join("");

listaProductos.splice(1,1);      // eliminar ese elemento y los siguientes según el 2do #
...
let seleccion = parseFloat(prompt(`${menu} \nSeleccione el producto: `));
